...
app.use((req, res, next) => {
	const allowedOrigins = [process?.env.REACT_APP_CLIENT_URL, 'http://localhost:5173/login', 'http://localhost:5174', 'http://localhost:5173', 'http://192.168.0.170:5173', 'http://localhost:4000'];
